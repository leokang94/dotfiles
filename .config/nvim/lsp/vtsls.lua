...
return {
	before_init = function(_, config)
		...
		local vscode_ts_settings = LspUtils.get_vscode_settings(config.root_dir, "typescript")
		...
		if next(vscode_ts_settings) then
			config.settings.typescript = vim.tbl_deep_extend("force", config.settings.typescript, vscode_ts_settings)
		end
	end,
